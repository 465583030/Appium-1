...
class team_AssignO(unittest.TestCase):
    # 1.创建数据库操作对象
    d = DataMysql()
    sql01 = "select * from test3_1_teamassign_01"
    sql03 = "select * from test3_1_teamassign_03"
    sql04 = "select * from test3_1_teamassign_04"
    sql05 = "select * from test3_1_teamassign_05"
